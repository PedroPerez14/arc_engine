...
#define ARC_CORE_ERROR(...)     ::ARC::Log::GetCoreLogger()->error(__VA_ARGS__) // __VA_ARGS__ forwards the variable arguments
...
#define ARC_ERROR(...)          ::ARC::Log::GetClientLogger()->error(__VA_ARGS__) // __VA_ARGS__ forwards the variable arguments
